DROP TRIGGER IF EXISTS enforce_two_active_devices_on_insert;
DROP TRIGGER IF EXISTS enforce_two_active_devices_on_reactivation;

CREATE TRIGGER enforce_one_active_device_on_insert
...
CREATE TRIGGER enforce_one_active_device_on_reactivation
